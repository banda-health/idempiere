CREATE OR REPLACE view bh_c_order_v(c_order_id, c_bpartner_id, grandtotal, paytotal, amtleft) as
    WITH payments AS (
...
SELECT register_migration_script('202010081426_GO-1352.sql') FROM dual;
